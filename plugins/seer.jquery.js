$.widget("custom.catcomplete", $.ui.autocomplete, {
    ...
    _renderItem: function (ul, item) {
        ...
        switch (item.ty) {
            case 0: // Category
                label = (brand) ? '<span class="dj-itemCategory">' + brand + ' <span class="dj-seperator">em</span> ' + title + '</span>' : '<span class="dj-itemCategory">' + title + ' <span class="dj-seperator">em</span> ' + cat + '</span>';
                break;
            case 1:  // Product
